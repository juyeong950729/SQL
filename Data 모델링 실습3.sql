...
insert into `Users`
(`userId`, `userName`, `userBirth`, `userGender`, `userHp`, `userPoint`, `userLevel`, `userAddr`, `userRegDate`) values
('user2', '계백', '1975-06-11', 'M', '010-1102-1975', 1000, 1, '서울', now());
insert into `Users`
(`userId`, `userName`, `userBirth`, `userGender`, `userHp`, `userPoint`, `userLevel`, `userAddr`, `userRegDate`) values
('user3', '김춘추', '1989-05-30', 'M', '010-1103-1989', 1200, 2, '서울', now());
...
insert into `Users`
(`userId`, `userName`, `userBirth`, `userGender`, `userHp`, `userPoint`, `userLevel`, `userAddr`, `userRegDate`) values
('user10', '허난설헌', '1992-09-07', 'F', '010-7103-1992', 4100, 3, '광주', now());
...
(`prodNo`, `cateNo`, `sellerNo`, `prodName`, `prodPrice`, `prodSold`, `prodDiscount`) values
(120101, 12, 10010, '암소 1등급 구이셋트 1.2kg', 150000, 87, 15);
insert into `Products`
(`prodNo`, `cateNo`, `sellerNo`, `prodName`, `prodPrice`, `prodSold`, `prodDiscount`) values
(120103, 12, 10010, '바로구이 부채살 250g', 21000, 61, 10);
...
insert into `Products`
(`prodNo`, `cateNo`, `sellerNo`, `prodName`, `prodPrice`, `prodSold`, `prodDiscount`) values
(141001, 14, 10001, '라떼 2인 소파/방수 패브릭', 320000, 42, 0);
...
insert into `Orders` values ('22010210002', 'user3', 56700, '서울기 강남구 21-1', 1, now());
...
insert into `Orders` values ('22010710110', 'user9', 94500, '광주시 충렬로 11', 1, now());
