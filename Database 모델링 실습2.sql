...
create user 'java2_admin6'@'%' identified by '1234';
grant all privileges on `java2_hospital`.* to 'java2_admin6'@'%';
flush privileges;

insert into `Departments` values (101, '소아과', '김유신', '051-123-0101');
insert into `Departments` values (102, '내과', '김춘추', '051-123-0102');
insert into `Departments` values (103, '안과', '장보고', '051-123-0103');
...
insert into `Doctors` values ('D102101', '김춘추', '1979-04-31', 'M', 102, '과장', '010-2101-1979', 'kimcc@bw.com');
...
insert into `Patients` (`pat-id`, `doc_id`, `nur_id`, `pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_job`) values ('P102101', 'D102101', 'N102101', '정우성', '760121-1234567', 'M', '서울', '010-1101-7601', '배우');
insert into `Patients` (`pat-id`, `doc_id`, `nur_id`, `pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_job`) values ('P103101', 'D103101', 'N103101', '이정재', '750611-1234567', 'M', '서울', '010-1102-7506', '배우');
...
insert into `Patients` (`pat-id`, `doc_id`, `nur_id`, `pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_job`) values ('P102103', 'D102104', 'N102102', '유재석', '721128-1234567', 'M', '부산', '010-6101-7211', '개그맨');
insert into `Patients` (`pat-id`, `doc_id`, `nur_id`, `pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_job`) values ('P107101', 'D107104', 'N107101', '강호동', '920907-1234567', 'M', '부산', '010-7103-9209', '개그맨');
