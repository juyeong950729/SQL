...
insert into `Professors` values ('P31104',31,'신사임당','711127-1234567','010-6101-1972','sinsa@hg.ac.kr','서울');
insert into `Professors` values ('P40101',40,'이이','910906-1234567','010-7103-1992','leelee@hg.ac.kr','서울');
insert into `Professors` values ('P40102',40,'이황','881208-1234567','010-7104-1989','hwang@hg.ac.kr','서울');
insert into `Professors` values ('P42103',42,'송상현','760313-1234567','010-8101-1977','ssh@hg.ac.kr','서울');
delete from `Professors` where `proNo` = 'P22110';
...
insert into `Students` (`stdNo`, `depNo`, `proNo`, `stdName`, `stdJumin`, `stdHp`, `stdAddr`) values ('22401001', 31, 'P31104', '강호동', '920907-1234567', '010-7103-9209', '부산');
...
insert into `Students` values ('21221010', 22, 'P22110', '장동건', '790728-1234567', '010-3101-8905', 'jang@naver.com', '대구');
...
delete from `Students` where `stdNo` = '22311014';
...
insert into `Lectures` values ('311002','P31101','통계학의 이해',2,10,'별관303');
insert into `Lectures` values ('311003','P31104','기초 통계학',2,10,'별관303');
insert into `Lectures` values ('401019','P40101','기계역학',2,10,'공학관 102');
insert into `Lectures` values ('421012','P42103','데이터베이스',2,10,'공학관 103');
